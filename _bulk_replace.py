"""Bulk find/replace + page rename for Narre Warren Pools & Pergolas scaffold."""
...
REPLACEMENTS = [
    ("https://geelongroofrestorations.com.au", "https://berwickpools.com.au"),
    ("geelongroofrestorations.com.au", "berwickpools.com.au"),
    ("geelongroofrestorations", "berwickpools"),
    ("Geelong Roof Restorations", "Narre Warren Pools &amp; Pergolas"),
    ...
    ("/services/roof-painting/", "/services/new-fibreglass-pool/"),
    ("/services/tile-restoration/", "/services/plunge-pool/"),
    ...
    ("Armstrong Creek", "Emerald"),
    ("Lara", "Hampton Park"),
    ("quotes@geelongroofrestorations.com.au", "quotes@berwickpools.com.au"),
    (">G</text>", ">P</text>"),
]
...
def main():
    ...
    if pkg.exists():
        ...
        s = s.replace('"name": "geelongroofrestorations"', '"name": "berwickpools"')
