# Narre Warren Pools &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `berwickpools.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://berwickpools.netlify.app |
...
├── whisper.js                # "Pete's Lead from Narre Warren Pools &amp; Pergolas" played to contractor before patching caller through
...
| `TENANT_BRAND` | `Narre Warren Pools &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Narre Warren Pools &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:berwickpools.com.au`).
4. Set up Google Business Profile (needs registered business name "Narre Warren Pools &amp; Pergolas" first).
